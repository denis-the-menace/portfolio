const en = {
  ...
  projects: [
    ...
    {
      mobileFileTitle: "tree-track",
      desktopFileTitle: "tree-track",
      title: "Tree Track",
      description:
        "Mobile app made with React Native and Firebase for tracking plant growth.",
      url: "https://github.com/denis-the-menace/TreeTrack",
    },
    {
      mobileFileTitle: "bilinear_scaling",
      desktopFileTitle: "bilinear_scaling",
      title: "Bilinear Scaling",
      description: "Parallel program made with C for image scaling.",
    ...
    },
    {
      ...
      description:
        "Parallel program made with C for image scaling using NVIDIA CUDA.",
    ...
    },
    {
      ...
      description: "AI program made for demonstrating adversarial search.",
    ...
    {
      mobileFileTitle: "cli_todos_app",
      desktopFileTitle: "cli_todos_app",
      title: "CLI Todo App",
      description:
        "Simple CLI todo app made with Node.js for my personal usage.",
      url: "https://github.com/denis-the-menace",
    },
    {
      ...
      description:
        "Veterinary system made with ASP.NET and provided authentication using JSON Web Token.",
    ...
    },
    {
      ...
      description:
        "Two truths one lie game made with Next.js, Express.js and Prisma where the questions are generated by ChatGPT.",
      url: "https://github.com/denis-the-menace",
    },
  ],
};
