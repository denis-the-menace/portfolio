const en = {
  ...
  about: {
    ...
    description: [
      "--i-am-a-tux-fan",
      "I am drawn to Linux-based operating systems and the freedom they provide. I thoroughly enjoy trying out new distros and seeing how they differ from one another.",
      "--i-am-a-cinephile",
